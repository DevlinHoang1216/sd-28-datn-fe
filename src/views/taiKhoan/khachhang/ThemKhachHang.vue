<template>
  <div class="customer-add-container">
    ...
    <Breadcrumb
      ...
      :show-page-info="true"
      page-title="Thêm Khách Hàng Mới"
      page-description="Tạo khách hàng mới cho hệ thống quản lý"
              ...
              <form @submit.prevent="submitForm">
                ...
                <div class="form-section">
                  <div class="section-header">
                    ...
                    <p class="section-description">Nhập thông tin cơ bản của khách hàng</p>
                  </div>
